...
return Def.ActorFrame{
	Def.Quad { OnCommand=function(self) self:zoomto(34,9999):vertalign(reverse and bottom or top):diffuse(color("#FFFFFF")):diffusealpha(background) end },
	Def.Quad { OnCommand=function(self) self:zoomto(2,9999):vertalign(reverse and bottom or top):x(18):diffuse(color("#3B3B3B")) end },
	Def.Quad { OnCommand=function(self) self:zoomto(2,9999):vertalign(reverse and bottom or top):x(-18):diffuse(color("#3B3B3B")) end },
	Def.Sprite {
		Texture="base light",
		Frame0000=0,
