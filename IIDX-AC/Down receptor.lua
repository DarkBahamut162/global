...
return Def.ActorFrame{
	...
	Def.Sprite {
		...
		Frame0000=0,
		Delay0000=1,
		InitCommand=function(self) self:addy(20):effectclock("beat"):zoomtowidth(64):blend('BlendMode_Add'):diffuseramp():effectcolor1(color("1,1,1,.2")):effectcolor2(color("1,1,1,1")):rotationz(180) end
	},
	Def.Sprite {
		Texture="RED_LINE",
	...
	Def.Sprite {
		...
		OnCommand=function(self) self:vertalign(top):y(-5):rotationz(180):zoom(1.28) end
	},
	Def.Sprite {
