...
return Def.ActorFrame{
	Def.Quad { OnCommand=function(self) self:zoomto(26,9999):vertalign(reverse and bottom or top):diffuse(color("#808080")):diffusealpha(background) end },
	...
	Def.Sprite {
		...
		OnCommand=function(self) self:vertalign(reverse and top or bottom):y(reverse and 16 or -16) end
	},
	Def.Sprite {
		Texture="Key2 Light",
		Frame0000=0,
